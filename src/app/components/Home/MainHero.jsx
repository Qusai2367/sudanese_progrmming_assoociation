    ...
    return (
        <section className="d-flex flex-column flex-lg-row align-items-center justify-content-between spacing">
            <div className="text-start d-flex flex-column gap-3">
                ...
                <h1 className="text-white textDarkMode fw-bold display-4 lh-tight fs-7">
                    Sudanese,
                    <br /> Programming Association
                </h1>
                <h3
                    className="fs-5 fw-normal lh-base brand"
                ...
                <div className="d-flex gap-3 mt-3">
                    <button className="btn bg-remain text-white fw-bold px-4 py-2 rounded-pill bg-main portofolio transition">
                        Portfolio
                    </button>
                    <button className="btn btn-outline-light fw-bold px-4 py-2 rounded-pill fs-normal lets build transition">
                        Let's Build 
                    </button>
                </div>
                <div className="d-flex gap-4 mt-4">
                    <div>
                        <h3 className="text-white fw-bold textDarkMode">450+</h3>
