            ...
            {posts.length === 0 ? (
                ...
                posts.map((post) => (
                    <div className="col " key={post.id}>
                        <div className="card h-100 border-0 rounded-4 p-2 overflow-hidden shadow-sm transition-shadow duration-300 bg-gray-800 ">
                            <div
                            ...
                            <div className="card-body p-4 d-flex flex-column gap-2 ">
                                <div className="d-flex align-items-center gap-2">
                                    ...
                                    />
                                    <div  style={{display:"flex",flexDirection:"column", }} className="mt-3 ml-4">
                                ...
                                <div className="d-flex justify-content-between align-items-center mt-auto">
                                    <div className="d-flex align-items-center gap-2">
                                        <Heart size={18} className="text-gra" />
